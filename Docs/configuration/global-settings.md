...
| Setting | Description |
|---------|-------------|
| `telemetryOptOut` | If set to true disables the collection of usage data for the EPAC repo. The default is false. See [Usage Tracking](../index.md#telemetry) for more information. |
...
Starting with v8.0.0, Enterprise Policy as Code (EPAC) is tracking the usage using Customer Usage Attribution (PID). See [Usage Tracking](../index.md#telemetry) for more information on opt out. Default is false.
